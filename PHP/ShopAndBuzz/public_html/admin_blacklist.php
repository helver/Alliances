<?php
  ...
  $config->setAttribute("BuzzUserFilterLabel", "Buzz User");
  $config->setAttribute("VictimFilterLabel", "Blacklistee");
  ...
  $lv = new ListView("admin_blacklist", "aswas", "", $config, $dbh, $debug);
  ...
  $smarty->assign("title_string", "Black List");
  $smarty->assign("lv", $lv);
