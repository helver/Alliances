<?php /* Smarty version 2.6.16, created on 2007-07-27 16:24:08
         compiled from honeycomb_list_nologgedin.tpl */ ?>
...
<h2><?php echo $this->_tpl_vars['userlabel']; ?>
 Honeycomb <?php echo $this->_tpl_vars['title_string']; ?>
</h2>
...
<?php $this->assign('t_list', 'honeycomb');  $this->assign('list_label', 'Honeycomb');  unset($this->_sections['friend']);
$this->_sections['friend']['name'] = 'friend';
$this->_sections['friend']['loop'] = is_array($_loop=$this->_tpl_vars['honeycomb']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
	<?php $this->assign('thisuser', $this->_tpl_vars['honeycomb'][$this->_sections['friend']['index']]['user']); ?>
	<?php $this->assign('reco', $this->_tpl_vars['honeycomb'][$this->_sections['friend']['index']]['reco']); ?>
	<tr><td class="whitetext"><a href="/users/<?php echo $this->_tpl_vars['thisuser']; ?>
