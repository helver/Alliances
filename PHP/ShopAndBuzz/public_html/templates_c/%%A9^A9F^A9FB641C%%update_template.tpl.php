<?php /* Smarty version 2.6.16, created on 2007-07-18 22:58:53
         compiled from update_template.tpl */ ?>
...
<form method="POST" enctype="multipart/form-data" action="/admin/files/<?php echo $this->_tpl_vars['template']; ?>
/">
...
?>
<form method="GET" action="/admin/files/<?php echo $this->_tpl_vars['template_files'][$this->_sections['tfile']['index']]['uri']; ?>
">
<tr>
