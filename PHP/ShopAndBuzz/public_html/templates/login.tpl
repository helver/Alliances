...
<form action="/handle_login.php" method="POST">
		...
		<td><input type="text" name="username" value="{$login_username}" size="15" maxlength="150" class=formfield><br><input type="password" name="password" size="10" maxlength="20" class=formfield></td></tr>
		<tr align=left valign=top>
