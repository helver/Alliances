...
<tr valign=top><td nowrap><p class="whitetext"><b>Choose The Image For Your Widget:</b></p>
  <p class="whitetext"><input type="radio" name="img" value="" onClick="img_name=null; use_text=true; recalc_widget(this.form, '{$user}');">No Image</p>
...
{section name=i loop=$text_text}
  <tr><td class="whitetext"><input type="radio" name="ttext" value='{$text_text[i]}' onClick="text_text=this.value; recalc_widget(this.form, '{$user}');">{$text_text[i]}<br><img src="/thematics/spacer.gif" width="26" height="3" border="0"><br></td></tr>
{/section}
</table>
</td>
...
{section name=img loop=$notext_images}
  <p><input type="radio" name="img" value="{$notext_images[img]}" onClick="img_name=this.value; use_text=false; recalc_widget(this.form, '{$user}');"><img src="/thematics/{$notext_images[img]}" align=top /></p>
{/section}
</td></tr>
