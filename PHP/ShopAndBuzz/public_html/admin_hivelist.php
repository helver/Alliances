<?php
  ...
  $config->setAttribute("BuzzUserFilterLabel", "Hive Owner");
  $config->setAttribute("VictimFilterLabel", "Hive Member");
  ...
  $lv = new ListView("admin_hivelist", "aswas", "", $config, $dbh, $debug);
  ...
  $smarty->assign("title_string", "Hive List");
  $smarty->assign("lv", $lv);
