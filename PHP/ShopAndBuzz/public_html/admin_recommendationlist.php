<?php
  ...
  $config->setAttribute("BuzzUserFilterLabel", "Recommender");
  $config->setAttribute("VictimFilterLabel", "Recommendee");
  ...
  $smarty->assign("title_string", "Recommendation List");
  $smarty->assign("lv", $lv);
