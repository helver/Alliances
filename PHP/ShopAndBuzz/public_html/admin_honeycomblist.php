<?php
  ...
  $config->setAttribute("BuzzUserFilterLabel", "Honeycomb Owner");
  $config->setAttribute("VictimFilterLabel", "Honeycomb Member");
  ...
  $lv = new ListView("admin_honeycomblist", "aswas", "", $config, $dbh, $debug);
  ...
  $smarty->assign("title_string", "Honeycomb List");
  $smarty->assign("lv", $lv);
