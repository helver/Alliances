<?php
  ...
  $config->setAttribute("BuzzUserFilterLabel", "User");
  
  $filter_names = array(
    "BuzzUser",
  );

  $lv = new ListView("admin_usermessageslist", "aswas", "", $config, $dbh, $debug);
  ...
  $smarty->assign("title_string", "User Messages List");
  $smarty->assign("lv", $lv);
