<?php
  ...
  $config->setAttribute("BuzzUserFilterLabel", "Referrer");
  $config->setAttribute("VictimFilterLabel", "Referree");
  $config->setAttribute("SellerFilterLabel", "Referred Seller");
  ...
  $smarty->assign("title_string", "Referral List");
  $smarty->assign("lv", $lv);
