 ...
 *
 * Class: ViewTemplate.php
 * Author: Eric Helvey
 * Create Date: 1/3/2003
 *
 * Description: Template used to display TableUpdate single record display pages.
 *
...
*/
  ...
  # we want.
  include_once("Features/DBView.inc");
  $rpt = new DBView($this, $this->config, $debug);
